  ...
  function start(root, opts) {
    ...
    function mount() {
      root.innerHTML =
        ...
        '<label>OD °F <input id="sb-out" type="range" min="60" max="115" value="95" /></label>' +
        '<label>ID °F <input id="sb-in" type="range" min="65" max="85" value="75" /></label>' +
        ...
        '<p style="font-size:12px;opacity:.85">Phone tip: gauges first. Full CoolGame trays load on a bigger screen later.</p>' +
        "</main></div>";
