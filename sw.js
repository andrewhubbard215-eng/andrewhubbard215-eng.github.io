...
const VER = "lt-allstars-v319";
const CORE = [
  "./",
  "./index.html",
  "./sku.js?v=13",
  "./style.css?v=144",
  "./sandbox-layout.css?v=1",
  ...
  "./sandbox.js?v=150",
  "./sandbox-hook.js?v=15",
  "./sandbox-ts.js?v=6",
  "./sandbox-sliders.js?v=3",
...
self.addEventListener("fetch", (e) => {
  ...
  if (url.pathname.indexOf("/.well-known/") === 0) return;
