...
(function (global) {
  ...
  var CSS =
    ...
    "#electrical-root.el-lite .el-nocool input{width:18px;height:18px;margin-top:2px;flex:0 0 auto}";
  ...
  function start(root, opts) {
    ...
    function paint() {
      ...
      root.innerHTML =
        ...
        (defuse
          ? "Then land the path · R C Y G W → screws"
      ...
      if (defuse) {
        root.querySelectorAll("[data-nc]").forEach(function (inp) {
          ...
          inp.onchange = function () {
            ...
            if (n >= 4) msg("Sheet clear — now land R/C/Y on the screws. Meter beat parts.");
            else msg("No-cool sheet " + n + "/4 — meter before you chase Y.");
          };
        });
      }
      msg(
