...
(function (global) {
  "use strict";
  const CALLS = [
    { name: "Mrs. Delgado", avatar: "🏠", job: "Row home · AC blowing warm", plate: "R-410A TXV · nameplate 6.3 lb · ODT 92° · IDB 78° / IWB 64°", vitals: "SH 28° · SC 4° · Suction low · Head low",
    ...
    { name: "Ken · Barbershop", avatar: "🪜", job: "Storefront · suction iced", plate: "R-410A TXV · ODT 88° · IDB 72° · 1\" filter black", vitals: "SH ~0° · SC normal · Filter black · Low airflow",
    ...
    { name: "Priya · Office", avatar: "🏢", job: "One zone dead", plate: "R-410A TXV · 3-zone · ODT 90° · conf room IDB 81°", vitals: "That zone SH 35° · SC 14° · Liquid cold at evaporator",
    ...
    { name: "Uncle Ray", avatar: "🏡", job: "Ranch · condenser in junipers", plate: "R-22 TXV · ODT 95° · IDB 80° · 18\" clearance gone", vitals: "High head · High SC · High amps · Coil matted",
    ...
    { name: "DIY Dave", avatar: "🔧", job: "Garage · system opened", plate: "R-410A TXV · lines cut · no recovery · oil on the slab", vitals: "Open to atmosphere · oil smell · no recovery gear",
    ...
    { name: "Jess & Marcus", avatar: "🌃", job: "Apartment · 11pm · no cool after install", plate: "R-410A TXV · factory 6.3 lb · 75 ft lineset · ODT 84°", vitals: "SH 22° · SC 2° · Long lineset · Bubble in glass",
  ...
  function render() {
    ...
    vit.innerHTML = "<strong>NO-COOL SHEET</strong> · Complaint + site notes only" +
      (c.plate ? " · <em>Nameplate</em> " + c.plate : "") +
      (site ? " · " + site : "") +
