...
const VER = "lt-allstars-v262";
const CORE = [
  "./",
  "./index.html",
  "./sku.js?v=10",
  "./style.css?v=139",
  "./phone-floor.css?v=13",
  "./sb-tabs.css?v=2",
  "./lab-glass.css?v=1",
  "./game.js?v=205",
  "./shop-floor-copy.js?v=8",
  "./sandbox.js?v=133",
  "./sandbox-hook.js?v=12",
  "./route-floor.js?v=5",
  "./charge-floor.js?v=2",
  "./quiz-arena.js?v=4",
  ...
  "./truck-pouch.js?v=2",
  "./truck-pouch.p0.js?v=2",
  "./truck-pouch.p1.js?v=2",
  "./truck-pouch.p2.js?v=2",
  "./truck-pouch.p3.js?v=2",
  "./truck-pouch.p4.js?v=2",
  "./truck-pouch.p5.js?v=2",
  "./truck-pouch.p6.js?v=2",
  "./truck-pouch.p7.js?v=2",
  "./truck-pouch.css?v=2",
  "./exam-untimed.js?v=2",
  "./board-codes.css?v=4",
  "./dragdrop.js?v=46",
